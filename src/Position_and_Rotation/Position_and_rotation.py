...
topN = analyzer.contours            # ← list of contours
# Select specific shapes in the list of topN
selected_indices = [0, 1, 2, 9]
# 4 Puzzle contours
selected_contours=[]
# Translated and Rotated contours.
translated_contours =[]
...
selected_contours = []
for i, cnt in enumerate(topN):
    if i in selected_indices:
        selected_contours.append(cnt.reshape(-1, 2))

plot_contours(selected_contours)
plot_center(selected_contours)
draw_box(selected_contours)
